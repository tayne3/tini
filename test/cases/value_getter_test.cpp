...
TEST_CASE("String Getters - tini_key_get") {
...
TEST_CASE("String Getters - tini_key_get_string") {
    tini_t*         ini = tini_empty();
    tini_section_t* sec = tini_get_section(ini, "test");
    tini_key_t*     key = tini_section_add_key(sec, "str", "hello");
...
TEST_CASE("Integer Getters - int valid") {
    struct {
        int         expected;
        const char* value;
    } cases[] = {
...
TEST_CASE("Integer Getters - int invalid") {
...
TEST_CASE("64-bit Integer Getters - i64 valid") {
    struct {
        int64_t     expected;
        const char* value;
    } cases[] = {
...
TEST_CASE("64-bit Integer Getters - i64 invalid") {
...
TEST_CASE("64-bit Integer Getters - u64 valid") {
    struct {
        uint64_t    expected;
        const char* value;
    } cases[] = {
...
TEST_CASE("64-bit Integer Getters - u64 invalid") {
...
TEST_CASE("Double Getters - double valid") {
    struct {
        double      expected;
        const char* value;
    } cases[] = {
...
TEST_CASE("Double Getters - double invalid") {
...
TEST_CASE("Boolean Getters - bool true values") {
...
TEST_CASE("Boolean Getters - bool false values") {
...
TEST_CASE("Boolean Getters - bool invalid values") {
