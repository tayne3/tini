...
TEST_CASE("Add/Get/Find Key - Add key") {
...
TEST_CASE("Add/Get/Find Key - Get key creates") {
    tini_t*         ini = tini_empty();
    tini_section_t* sec = tini_get_section(ini, "test");
...
TEST_CASE("Add/Get/Find Key - Find key does not create") {
    tini_t*         ini = tini_empty();
    tini_section_t* sec = tini_get_section(ini, "test");
...
TEST_CASE("Add/Get/Find Key - Has key") {
    tini_t*         ini = tini_empty();
    tini_section_t* sec = tini_get_section(ini, "test");
...
TEST_CASE("Add/Get/Find Key - Key case insensitivity") {
    tini_t*         ini = tini_empty();
    tini_section_t* sec = tini_get_section(ini, "test");
...
TEST_CASE("Add/Get/Find Key - Key complex names") {
    const char* names[] = {
        "key_with_underscore",
        "key-with-hyphen",
        "key.with.dots",
...
TEST_CASE("Set/Modify Value - Set value") {
    tini_t*         ini = tini_empty();
    tini_section_t* sec = tini_get_section(ini, "test");
...
TEST_CASE("Set/Modify Value - Overwrite key") {
    tini_t*         ini = tini_empty();
    tini_section_t* sec = tini_get_section(ini, "test");
...
TEST_CASE("Remove Key - Remove key") {
    tini_t*         ini = tini_empty();
    tini_section_t* sec = tini_get_section(ini, "test");
...
TEST_CASE("Remove Key - Remove key not found") {
    tini_t*         ini = tini_empty();
    tini_section_t* sec = tini_get_section(ini, "test");
...
TEST_CASE("Remove Key - Remove key case insensitive") {
    tini_t*         ini = tini_empty();
    tini_section_t* sec = tini_get_section(ini, "test");
...
TEST_CASE("Direct Key Access - Direct get key") {
    tini_t* ini = tini_empty();
...
TEST_CASE("Direct Key Access - Direct find key") {
    tini_t* ini = tini_empty();
...
TEST_CASE("Direct Key Access - Direct key default section") {
    tini_t*     ini       = tini_empty();
