...
TEST_CASE("Long Strings - Very long key") {
...
TEST_CASE("Long Strings - Very long value") {
    const size_t SIZE = 10 * 1024;
...
TEST_CASE("Long Strings - Very long section name") {
...
TEST_CASE("Empty/NULL Values - Empty string value") {
    tini_t*         ini = tini_empty();
    tini_section_t* sec = tini_get_section(ini, "test");
...
TEST_CASE("Empty/NULL Values - NULL value") {
    tini_t*         ini = tini_empty();
    tini_section_t* sec = tini_get_section(ini, "test");
...
TEST_CASE("Special Characters - Special chars in value") {
    tini_t*         ini = tini_empty();
...
TEST_CASE("Special Characters - Quoted special values") {
    tini_t*         ini = tini_empty();
...
TEST_CASE("Bulk Operations - Many keys in section") {
    tini_t*         ini = tini_empty();
...
TEST_CASE("Bulk Operations - Massive section count") {
    tini_t* ini = tini_empty();
...
TEST_CASE("Whitespace - Whitespace only value") {
    tini_t*         ini = tini_empty();
    tini_section_t* sec = tini_get_section(ini, "test");
