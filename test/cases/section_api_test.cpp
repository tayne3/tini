...
TEST_CASE("Get/Find Section - Get section creates") {
...
TEST_CASE("Get/Find Section - Find section does not create") {
    tini_t*         ini = tini_empty();
...
TEST_CASE("Get/Find Section - Section case insensitivity") {
    tini_t* ini = tini_empty();
...
TEST_CASE("Get/Find Section - Section empty name") {
    tini_t*         ini       = tini_empty();
...
TEST_CASE("Get/Find Section - Section complex names") {
    const char* names[] = {
...
TEST_CASE("Remove Section - Remove section") {
    tini_t* ini = tini_empty();
...
TEST_CASE("Remove Section - Remove section not found") {
    tini_t* ini    = tini_empty();
...
TEST_CASE("Remove Section - Remove section case insensitive") {
    tini_t* ini = tini_empty();
...
TEST_CASE("Bulk Operations - Many sections") {
    tini_t* ini = tini_empty();
