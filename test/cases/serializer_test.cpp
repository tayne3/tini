...
TEST_CASE("Basic Save - Save basic") {
...
TEST_CASE("Basic Save - Save multiple sections") {
...
TEST_CASE("Round-trip - Round-trip basic") {
...
TEST_CASE("Round-trip - Round-trip special chars") {
...
TEST_CASE("Round-trip - Round-trip empty values") {
...
TEST_CASE("Round-trip - Round-trip unicode") {
...
TEST_CASE("Large Files - Save large file") {
