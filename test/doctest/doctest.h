...
#define STATIC_REQUIRE(cond) static_assert(cond, #cond); REQUIRE(cond)
#endif
#ifndef STATIC_REQUIRE_FALSE
#define STATIC_REQUIRE_FALSE(cond) static_assert(!(cond), #cond); REQUIRE_FALSE(cond)
#endif
